    ...
    return (
        <div className="home-page">
            ...
            <main id="main-content">
                ...
                >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-xl shrink-0">🔮</div>
                    <div className="min-w-0 flex-1">
                        <p className="text-white font-bold text-sm leading-tight">Ask Aadi, Your AI Astrologer</p>
                        <p className="text-indigo-200/70 text-xs">5 free questions · instant answers</p>
                    </div>
