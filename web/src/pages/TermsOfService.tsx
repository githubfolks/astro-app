    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 md:py-16 max-w-4xl mb-4">
                <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mt-4 mb-4 md:mb-8 text-center">Terms of Service</h1>
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Wallet, Purchases, and Subscriptions</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Astrologer Terms</h2>
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">AI Astrologer ("Aadi")</h2>
                    <p>
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Courses and Classroom</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">User Conduct and Prohibited Content</h2>
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Role of AadiKarta and Limitation of Liability</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Intellectual Property</h2>
                    <p>
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Account Termination</h2>
