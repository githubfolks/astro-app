        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 md:py-16 max-w-4xl mb-4">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Astrological Content and Predictions</h2>
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Not Professional Advice</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 pt-4">Independent Astrologers</h2>
                    <p>
