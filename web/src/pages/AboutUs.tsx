    ...
    return (
        <div className="about-page">
            ...
            <div className="container" style={{ padding: '60px 20px', minHeight: '60vh', textAlign: 'center' }}>
                <h1 style={{ fontSize: '32px', marginBottom: '20px', color: '#1A1A1A' }}>About AstroApp</h1>
                <p style={{ maxWidth: '800px', margin: '0 auto', color: '#666', lineHeight: '1.8' }}>
                    Welcome to AstroApp, India's most trusted astrology platform. We bridge the gap between ancient vedic wisdom and modern technology.
