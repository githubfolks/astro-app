...
const KEYWORD_LINK_MAP: Array<{ keyword: string; url: string }> = [
    ...
    { keyword: 'AstroTalk alternative', url: '/vs/astrotalk' },
    { keyword: 'AstroSage alternative', url: '/vs/astrosage' },
    { keyword: 'AstroYogi alternative', url: '/vs/astroyogi' },
    { keyword: 'AstroTalk', url: '/vs/astrotalk' },
    { keyword: 'AstroSage', url: '/vs/astrosage' },
