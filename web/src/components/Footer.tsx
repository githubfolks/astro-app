    ...
    <footer className="footer-section native-footer">
        <div className="container">
            ...
            <div className="social-links">
                ...
                <a href="https://www.instagram.com/astro_aadikarta_2026/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Visit our Instagram profile"><Instagram size={20} /></a>
