            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="memory-guru-content flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-3/5" data-aos="fade-right">
                        ...
                        <h2 className="memory-guru-title text-3xl md:text-4xl text-gray-900 mb-6">
                            Unlock Extraordinary Memory Power with <span className="text-indigo-600">Rajesh Chaudhary</span> – Memory Guru
                        </h2>

                        <p className="memory-guru-description text-xl text-gray-600 leading-relaxed mb-8">
                        ...
                        {/* Program Tags */}
                        <div className="memory-guru-tags flex flex-wrap gap-4 mb-10">
                        ...
                        {/* Buttons */}
                        <div className="memory-guru-buttons flex flex-col sm:flex-row gap-4">
                            <Link
                                to="/book"
                    ...
                    <div className="memory-guru-media lg:w-2/5" data-aos="fade-left">
                        <div className="bg-gradient-to-tr from-indigo-100 to-purple-50 rounded-[3rem] p-4 relative">
                            ...
                            <img
                                ...
                                className="memory-guru-photo w-full h-[500px] object-cover rounded-[2.5rem] shadow-2xl relative z-10 filter contrast-110"
                                width="400"
                                height="500"
                            />

                            {/* Floating Badge */}
                            <div className="memory-guru-badge absolute -bottom-8 -left-8 bg-white p-6 rounded-3xl shadow-xl z-20 flex items-center gap-4 border border-gray-100">
